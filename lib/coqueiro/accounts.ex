defmodule Coqueiro.Accounts do
  @moduledoc """
  ...
  alias Coqueiro.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Coqueiro.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Coqueiro.Accounts.User.password_changeset/3` for a list of supported options.
  ...
  def subscribe_organizations(%Scope{} = scope) do
    ...
    Phoenix.PubSub.subscribe(Coqueiro.PubSub, "user:#{key}:organizations")
  end
