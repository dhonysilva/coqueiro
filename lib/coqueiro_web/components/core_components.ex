defmodule CoqueiroWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CoqueiroWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CoqueiroWeb.Gettext, "errors", msg, opts)
    end
  end
