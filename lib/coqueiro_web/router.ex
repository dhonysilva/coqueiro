defmodule CoqueiroWeb.Router do
  use CoqueiroWeb, :router

  import CoqueiroWeb.UserAuth
  ...
  # scope "/api", CoqueiroWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:coqueiro, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CoqueiroWeb.Telemetry
